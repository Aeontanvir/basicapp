...
public class BasicappApp {

    private static final Logger log = LoggerFactory.getLogger(BasicappApp.class);

    private final Environment env;

    public BasicappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes basicapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BasicappApp.class);
